module VMail.Viz {
  ...
  export class NetworkViz {
    ...
    private LABEL_THRESHOLD = 3;
    clustercolors = true;
    private neighbors_num = null;
    private drag_node = null;
    private glowing: bool;
    private labelsVisible: bool;
    ...
    constructor (settings: VizSettings, for_guestbook: bool) {
      ...
      if(!this.guestbook) {
        this.svg.append("svg:image")
          .attr("width", 150)
          .attr("height", 25)
          .attr("xlink:href", "/static/images/basic-name-logo.png")
          .attr("x", 5)
          .attr("y", 15)
          .attr("opacity", 0.8);
      }
