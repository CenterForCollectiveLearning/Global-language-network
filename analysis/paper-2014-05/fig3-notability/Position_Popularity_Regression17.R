...
#     "Book.PopFrom margin over Pop+GDPpc+Book.EV: Pop+GDPpc+Book.EV+Book.PopFrom vs. Pop+GDPpc+Book.EV", my.ftest(lm7, lm16)
  ...
  clarke.results <- c(
    "GDP+Pop vs. Twit.EV:", capture.output(clarke(lm1, lm2, level=0.01, digits=2)),
    "GDP+Pop vs. Wiki.EV:", capture.output(clarke(lm1, lm3, level=0.01, digits=2)),
    "GDP+Pop vs. Book.EV:", capture.output(clarke(lm1, lm4, level=0.01, digits=2))
  )
